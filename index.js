...
const UUID = process.env.UUID || '2692a206-7cdc-47e6-b4c3-1a0e1e057d2b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || '2692a206-7cdc-47e6-b4c3-1a0e1e057d2b';            // 获取节点的订阅路径
